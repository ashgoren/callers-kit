...
- `schema.ts` — the local SQLite client schema. Currently minimal (`dances.title` only) — deliberately not a 1:1 mirror of the Postgres schema; only columns the app actually reads/writes locally need to be declared here.
